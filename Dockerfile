...
# SPDX-FileCopyrightText: 2026 The condition-github-actions Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-condition-github-actions" \
      org.opencontainers.image.description="semrel plugin: condition-github-actions" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/condition-github-actions" \
